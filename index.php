        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">última actualización: <code>20/8/20</code>.</h3>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 text-center"><button class="btn btn-success btn-sm">ver más</button></div>
                    <div class="col-lg-4 col-sm-6 mb-4"></div>
                </div>
            </div>
        </section>
